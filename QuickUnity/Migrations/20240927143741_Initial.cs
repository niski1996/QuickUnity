        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrainerRowId = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfileRowId = table.Column<Guid>(type: "uuid", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrainerRow", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TrainerRow_ProfileRow_ProfileRowId",
                        column: x => x.ProfileRowId,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "text", nullable: false),
                    InsertDate = table.Column<DateOnly>(type: "date", nullable: false, defaultValueSql: "NOW()"),
                    Description = table.Column<string>(type: "text", nullable: false),
                    Name = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    Path = table.Column<string>(type: "text", nullable: false),
                    ProfileRowId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VideoRow", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VideoRow_ProfileRow_ProfileRowId",
                        column: x => x.ProfileRowId,
                        principalTable: "ProfileRow",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainerRow_ProfileRowId",
                table: "TrainerRow",
                column: "ProfileRowId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_VideoRow_ProfileRowId",
                table: "VideoRow",
                column: "ProfileRowId");
